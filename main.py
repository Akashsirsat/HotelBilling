...
def bill_button_operation():
    ...
    if ans=="yes":
        ...
        st = "\t\t\t\tG3 Hotel\n\t\t\tWeb G3, Kolkata-700 002\n"
        st += "\t\t\tGST.NO:- 56AMZPP3365KO\n"
        st += "-"*61 + "BILL" + "-"*61 + "\nDate:- "
...
root.title("Hotel Billing System by Group 3")
...
title_label = Label(title_frame, text="G3 Hotel",
                    font=("times new roman", 20, "bold"),bg = "deeppink", fg="yellow", pady=5)
title_label.pack()

#==============Customer=============
customer_frame = LabelFrame(root,text="Customer Details",font=("times new roman", 15, "bold"),
                            bd=8, bg="black", fg='white', relief=GROOVE)
...
menu_label = Label(menu_frame, text="Menu", 
                    font=("times new roman", 20, "bold"),bg = "pink", fg="red", pady=0)
...
#menu_tabel.heading("category",text="Categorey")
...
#===============Item Frame=============
item_frame = Frame(root,bd=8, bg="gray", relief=GROOVE)
...
item_name_label = Label(item_frame2, text="Name", 
                    font=("arial", 12, "bold"),bg = "lightgray", fg="blue")
...
item_frame3 = Frame(item_frame, bg="lightgray")
